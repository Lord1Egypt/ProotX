...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "ProotX";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_STOP_SERVICE.equals(action)) {
            ...
            if (username.isEmpty() || hostname.isEmpty() || port.isEmpty() || sessionName.isEmpty()) {
                Log.e(EmulatorDebug.LOG_TAG, "Currently only intents from ProotX are supported");
            } else {
    ...
    String GROUP_KEY_PROOTX = "io.github.lord1egypt.prootx.sessions";
    ...
    private Notification buildNotification() {
        ...
        builder.setGroup(GROUP_KEY_PROOTX);
