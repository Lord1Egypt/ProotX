...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    private void parseProotXIntent(String intentData) {
        ...
        try {
            ...
            showErrorAndGoBackToProotX(R.string.error_regex_parsing, e.getMessage());
        }
    }

    void showErrorAndGoBackToProotX(@StringRes int resId, String extraInfo) {
