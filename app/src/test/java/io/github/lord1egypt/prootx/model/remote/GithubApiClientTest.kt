package io.github.lord1egypt.prootx.model.remote
...
class GithubApiClientTest {
    ...
    private val testEndpoint = "/repos/Lord1Egypt/ProotX-Assets-$testRepo/releases/$testReleaseToUse"
    ...
    @Before
    fun setup() {
        whenever(mockProotXFiles.getArchType()).thenReturn(testArch)

        githubApiClient = GithubApiClient(mockProotXFiles, mockUrlProvider, mockLogger)
    }
