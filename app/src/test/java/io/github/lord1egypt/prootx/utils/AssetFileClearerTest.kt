...
class AssetFileClearerTest {
    ...
    fun setup() {
        ...
        assetFileClearer = AssetFileClearer(mockProotXFiles, assetDirectoryNames, busyboxExecutor, mockLogger)
    }
    ...
    private fun createTestFiles() {
        ...
        whenever(mockProotXFiles.filesDir).thenReturn(filesDir)
        whenever(mockProotXFiles.busybox).thenReturn(topLevelSupportAssetFile)
    }
