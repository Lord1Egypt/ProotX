...
import io.github.lord1egypt.prootx.viewmodel.IllegalState
...
interface Logger {
    ...
    fun addBreadcrumb(breadcrumb: ProotXBreadcrumb)
...
class SentryLogger : Logger {
    ...
    override fun addBreadcrumb(breadcrumb: ProotXBreadcrumb) {
