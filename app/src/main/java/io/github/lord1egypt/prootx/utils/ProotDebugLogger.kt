...
class ProotDebugLogger(defaultSharedPreferences: SharedPreferences, private val prootxFiles: ProotXFiles) {
    ...
    private val logLocation = "${prootxFiles.emulatedUserDir}/$logName"
    ...
    fun deleteLogs() {
        val scopedFiles = prootxFiles.emulatedUserDir.listFiles() ?: return
