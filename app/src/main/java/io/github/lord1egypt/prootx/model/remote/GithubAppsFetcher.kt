...
class GithubAppsFetcher(
    ...
    private val branch = "main" // Base off different support branches for testing.
    private val baseUrl = "https://github.com/Lord1Egypt/ProotX-Assets-Support/raw/$branch/apps"
