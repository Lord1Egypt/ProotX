package io.github.lord1egypt.prootx.model
...
import io.github.lord1egypt.prootx.model.repositories.* // ktlint-disable no-wildcard-imports
...
class MigrationTest {
    ...
    val helper = MigrationTestHelper(InstrumentationRegistry.getInstrumentation(),
        ProotXDatabase::class.java.canonicalName,
    ...
    fun migrate2To3() {
        ...
        assertEquals(fs.defaultVncPassword, "prootx")
    ...
    private fun getMigratedDatabase(): ProotXDatabase {
        val context = ApplicationProvider.getApplicationContext<Context>()
        val db = Room.databaseBuilder(context, ProotXDatabase::class.java, TEST_DB)
                .addMigrations(
                        Migration1To2(),
                        Migration2To3(),
                        Migration3To4(),
